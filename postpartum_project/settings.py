...
SECRET_KEY = 'django-insecure-s1_0qqo_n^-%3&#3$(uy-t^+d901ehpy8cyi#rl)gkvh)%)t8$'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'emotional_management', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
USE_TZ = True
#Direct to main page while login
